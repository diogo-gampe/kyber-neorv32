...
(
    ...
    localparam PAD1 = log2ceil(64'h100000 - 64'hf0000); 
    localparam PAD2 = log2ceil(64'h100040 - 64'h100000); 
    localparam PAD3 = log2ceil(64'h100048 - 64'h100040); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h100048;
    ...
    // ( 0xf0000 .. 0x100000 )
    if ( {address[RG:PAD1],{PAD1{1'b0}}} == 21'hf0000   ) begin
            src_channel = 4'b0010;
    ...
    // ( 0x100040 .. 0x100048 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 21'h100040   ) begin
            src_channel = 4'b0001;
