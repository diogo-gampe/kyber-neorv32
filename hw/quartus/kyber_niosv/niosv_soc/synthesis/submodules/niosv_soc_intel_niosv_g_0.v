...
`timescale 1 ps / 1 ps
module niosv_soc_intel_niosv_g_0 (
	...
	niosv_soc_intel_niosv_g_0_hart #(
		...
		.PERIPHERAL_REGION_A_SIZE (4096),
		.PERIPHERAL_REGION_A_BASE (32'b00000000000011110000000000000000),
		.PERIPHERAL_REGION_B_SIZE (0),
		.PERIPHERAL_REGION_B_BASE (32'b00000000000000000000000000000000),
		.DBG_DATA_S_BASE          (32'b000000000000000000000000000000-1),
		.TIMER_MSIP_DATA_S_BASE   (32'b00000000000100000000000000000000),
		.DTCM1_SIZE               (0),
	...
	niosv_soc_intel_niosv_g_0_irq_mapper irq_mapper (
		.clk           (clk),                      //       clk.clk
	...
	niosv_soc_intel_niosv_g_0_irq_mapper irq_mapper_001 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
	...
	niosv_soc_intel_niosv_g_0_irq_mapper irq_mapper_002 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
