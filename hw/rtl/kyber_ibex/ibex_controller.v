module ibex_controller (
	...
	generate
		...
		if (MemECC) begin : g_intg_irq_int
			reg load_intg_err_irq_pending_q;
			wire load_intg_err_irq_pending_d;
			reg [31:0] load_intg_err_addr_q;
			reg [31:0] load_intg_err_addr_d;
			reg load_intg_err_irq_set;
			reg load_intg_err_irq_clear;
			wire entering_nmi;
			...
			always @(*) begin
				...
				else if (load_intg_err_i) begin
					load_intg_err_addr_d = lsu_addr_last_i;
					load_intg_err_irq_set = 1'b1;
				end
			end
			assign load_intg_err_irq_pending_d = (load_intg_err_irq_pending_q & ~load_intg_err_irq_clear) | load_intg_err_irq_set;
			always @(posedge clk_i or negedge rst_ni)
				if (!rst_ni) begin
					load_intg_err_irq_pending_q <= 1'b0;
					load_intg_err_addr_q <= 1'sb0;
				end
				else begin
	...
	assign handle_irq = (~debug_mode_q & ~nmi_mode_q) & (irq_nm | (irq_pending_i & csr_mstatus_mie_i));
